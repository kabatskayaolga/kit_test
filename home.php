    ...
    <div class="slide active cat<?php echo $backcat; ?>" id="slide<?php echo $counter ?>">
      <div class="container">
        <div class="flex_container">
          <div class="content_text"><?php if(get_post_meta($post->ID, '_sale_price_dates_to', true) != ''){?>
            <div class="stock"><span>акция</span> до <?php $date = get_post_meta($post->ID, '_sale_price_dates_to', true); 
    ...
    <div class="sliders_nav__wrapper_overflow sliders__wrapper">
      <div class="sliders_nav__wrapper">
        ...
        <?php if ($counter == 0) { ?><a class="slider_nav active" href="#slide<?php echo $counter; ?>">
          ...
          echo get_the_post_thumbnail( $post->ID, 'woocommerce_single' );
          } else {
