...
if((isset($_POST['name'])&&$_POST['name']!="")&&(isset($_POST['phone'])&&$_POST['phone']!="")){ //Проверка отправилось ли наше поля name и не пустые ли они
        $to = 'svk.od.ua@gmail.com'; //Почта получателя, через запятую можно указать сколько угодно адресов
        ...
        $message = '
                <html>
                    ...
                    <h1 style="color: #202020; font-family: Helvetica Neue, Helvetica, Roboto, Arial, sans-serif; font-size: 30px; font-weight: 300; line-height: 150%; margin: 0; text-align: left; text-shadow: 0 1px 0 #98d787;">'.$subject.'</h1>
                    </td>
                    </tr></table>
                    ...
                    <p style="margin: 0 0 16px;">Имя: '.$_POST['name'].'</p>
                    <p style="margin: 0 0 16px;">Телефон: '.$_POST['phone'].'</p>';

                    if((isset($_POST['email'])&&$_POST['email']!="")){
                        $message .= '   <p style="margin: 0 0 16px;">Email: '.$_POST['email'].'</p>';
                    };
