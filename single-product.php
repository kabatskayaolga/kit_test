<?php get_header(); ?>
<section class="flex_container wrapper-flex_container col-2"><?php while ( have_posts() ) : the_post(); ?>
  <section class="content product">
    <div class="container"><?php do_action( 'woocommerce_before_main_content' ); ?></div>
      <div class="wrapper_block">
        <div class="flex_container flex_info__product">
          ...
          <div class="flex_container flex__column">
            <h1><?php the_title(); ?></h1>
            <h3 class="price">
               <?php echo $product->get_price_html(); ?><span class="pr">цена</span></h3>
            ...
            <div class="wrapper_block buttons"><a class="button buy" href="#" modal="#buy">Заказать прямо сейчас <i class="icon click"></i></a><?php if ( ! defined( 'ABSPATH' ) ) {
              	exit;
              }
              global $product;
    ...
    <section class="tab_parent info_block">
        ...
        <div class="container">
          <div class="wrapper_block">
            <div class="flex_container flex__left flex__center">
              <h4>Информация</h4><a class="tab_item active" href="#about">Описание</a><a class="tab_item" href="#characteristics">Характеристики</a><a class="tab_item" href="#reviews">
                 <?php _e( 'Reviews', 'woocommerce' ); ?></a>
            </div>
          </div>
        </div>
      </div>
      <div class="product_info">
        <div class="container">
          <div class="active products_tab" id="about"><?php the_content(); ?></div>
          ...
          <div class="products_tab" id="reviews"><?php comments_template( '/single-product-reviews.php', $separate_comments ); ?></div>
        </div>
      </div>
    </section><?php echo do_shortcode ('[related_products per_page="10"]'); ?>
