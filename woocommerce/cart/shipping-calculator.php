...
<form class="woocommerce-shipping-calculator" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
	...
	<section class="shipping-calculator-form" style="display:none;">
		...
		<p class="form-row form__item form-row-wide" id="calc_shipping_country_field">
		...
		<p class="form-row form__item form-row-wide" id="calc_shipping_state_field">
			<?php
		...
		<?php if ( apply_filters( 'woocommerce_shipping_calculator_enable_city', true ) ) : ?>
			...
			<p class="form-row form__item form-row-wide" id="calc_shipping_city_field">
		...
		<?php if ( apply_filters( 'woocommerce_shipping_calculator_enable_postcode', true ) ) : ?>
			...
			<p class="form-row form__item form-row-wide" id="calc_shipping_postcode_field">
